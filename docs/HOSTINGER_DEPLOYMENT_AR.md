...
- إذا كانت قاعدة البيانات موجودة بالفعل، خذ نسخة احتياطية ثم استورد ملفات الترحيل من آخر رقم مطبق حتى `database/mysql/030_client_dashboard_payment_promotions.sql` بالترتيب. لا تتخطَّ أي رقم، لأن بيع الباقات والمدفوعات وبداية الصلاحية وحسابات الموظفين وأرشيف الحذف الآمن تعتمد على 023–028، وإشعارات تطبيق Android تعتمد على 029، والدفع من لوحة العميل وطلبات عروض الموقع يعتمدان على 030.
