...
- إذا كانت قاعدة البيانات موجودة بالفعل، خذ نسخة احتياطية ثم استورد ملفات الترحيل من آخر رقم مطبق حتى `database/mysql/022_client_access_authority.sql` بالترتيب. الترحيلات 017–022 قابلة لإعادة التشغيل بأمان، وتضيف إجراءات المالك، ومنع تكرار إنشاء الخدمة المخصصة، وتسويات وقت الجلسات بالدقائق، وإشعارات العميل، وأمان كلمات المرور، ومرجع تفعيل دخول العميل.
