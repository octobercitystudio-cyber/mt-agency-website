...
if (preg_match('#^/client-packages/(\d+)/details$#',$path,$m)&&$method==='GET') {
    ...
    respond([
      ...
      'payments'=>$payments,'used_bookings'=>$usedBookings,'upcoming_bookings'=>$upcomingBookings,'usage_ledger'=>$usageLedger,'settlement_allocations'=>$settlementAllocations,'audit_timeline'=>$auditTimeline,
