...
function sendFirebasePush(array $config,string $token,array $notification): void {
    ...
    $message=['message'=>['token'=>$token,'notification'=>['title'=>$title,'body'=>$body],'data'=>['title'=>$title,'body'=>$body,'url'=>$url,'notification_id'=>$notificationId,'sync_topics'=>implode(',',$syncTopics)],'webpush'=>['headers'=>['Urgency'=>'high'],'fcm_options'=>['link'=>'https://multitaskagency.com'.$url]]]];
