  ...
  return <section ref={sectionRef} className="custom-schedule-card" aria-label="تحديد موعد الخدمة">
    ...
    <div className="custom-schedule-layout">
      ...
      <div className="custom-schedule-fields">
        ...
        <div className="custom-schedule-time"><label>من<BusinessTimeSelect required min="00:00" max="23:00" value={value.start_time} onChange={event => onChange({ ...value, start_time: event.target.value })}/></label><label>إلى<BusinessTimeSelect required min="00:15" max="24:00" value={value.end_time} onChange={event => onChange({ ...value, end_time: event.target.value })}/></label></div>
