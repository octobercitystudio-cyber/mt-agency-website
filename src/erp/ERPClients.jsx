          ...
          <div className="erp-modal-content" onClick={e => e.stopPropagation()} style={{  maxWidth: '500px', borderRadius: '1.5rem', padding: '30px', border: 'none' }}>
            ...
            <form onSubmit={handleSaveEditAppointment} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                <div><label style={{ fontSize: '0.85rem', fontWeight: 'bold', color: 'var(--erp-text-muted)', marginBottom: '5px', display: 'block' }}>وقت البدء</label><BusinessTimeSelect min="00:00" max="23:45" style={{ width: '100%', padding: '12px', borderRadius: '0.5rem', border: '1px solid var(--erp-border)', background: 'var(--erp-bg)', fontWeight: 'bold' }} value={currentEditAppointment.start_time || ''} onChange={e => setCurrentEditAppointment({...currentEditAppointment, start_time: e.target.value})} /></div>
                <div><label style={{ fontSize: '0.85rem', fontWeight: 'bold', color: 'var(--erp-text-muted)', marginBottom: '5px', display: 'block' }}>وقت الانتهاء</label><BusinessTimeSelect min="00:15" max="24:00" style={{ width: '100%', padding: '12px', borderRadius: '0.5rem', border: '1px solid var(--erp-border)', background: 'var(--erp-bg)', fontWeight: 'bold' }} value={currentEditAppointment.end_time || ''} onChange={e => setCurrentEditAppointment({...currentEditAppointment, end_time: e.target.value})} /></div>
              </div>
