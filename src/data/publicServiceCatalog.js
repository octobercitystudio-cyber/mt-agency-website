...
export const publicServiceCatalog = [
  ...
  entry('reels-production', 'reels', 'Smartphone', 'production', ['reels'], '/service-heroes/reels-production.webp', {
    ...
    seoTitle: 'تصوير ومونتاج ريلز احترافي في 6 أكتوبر', metaDescription: 'إنتاج وتصوير ريلز وفيديوهات قصيرة للبراندات والخبراء في 6 أكتوبر، من الفكرة حتى المونتاج الجاهز للنشر.', keywords: ['تصوير ريلز احترافي', 'مونتاج ريلز', 'فيديوهات قصيرة', 'صناعة محتوى سوشيال ميديا'],
  }, {
    ...
    seoTitle: 'Professional Reels Production in Giza, Egypt', metaDescription: 'Short-form video and Reels production for brands and experts in Giza, from ideas and filming to publish-ready vertical edits.', keywords: ['professional reels production', 'reels editing', 'short-form video', 'social video production'],
  }),
  entry('commercial-video-production', 'advertising', 'Clapperboard', 'production', ['video'], '/service-heroes/commercial-video-production.webp', {
    ...
    seoTitle: 'تصوير وإنتاج إعلانات تجارية في مصر', metaDescription: 'إنتاج فيديو دعائي وإعلان تجاري وفيديو براند في مصر، من الفكرة والسيناريو إلى التصوير والمونتاج والتسليم.', keywords: ['تصوير إعلانات', 'إنتاج فيديو دعائي', 'إعلان تجاري', 'تصوير منتجات'],
  }, {
    ...
    seoTitle: 'Commercial and Brand Video Production in Egypt', metaDescription: 'Commercial, product and brand video production in Egypt, from creative treatment and filming to final campaign delivery.', keywords: ['commercial video production', 'brand film', 'product filming', 'video advertising'],
  }),
  ...
  entry('social-media-management', 'social_media', 'Share2', 'marketing', ['reels', 'design'], '/service-heroes/social-media-management.webp', {
    ...
    seoTitle: 'شركة إدارة سوشيال ميديا في الجيزة', metaDescription: 'إدارة صفحات السوشيال ميديا للشركات في الجيزة بخطة محتوى وتصميم وإعلانات ممولة وتقارير أداء واضحة.', keywords: ['إدارة السوشيال ميديا', 'صناعة المحتوى', 'خطة محتوى', 'تصميم بوستات'],
  }, {
    ...
    seoTitle: 'Social Media Management Agency in Giza', metaDescription: 'Social media management for Giza businesses, including content planning, design, paid campaigns and clear reporting.', keywords: ['social media management', 'content strategy', 'post design', 'paid social campaigns'],
  }),
  ...
  entry('web-design-development', 'website', 'MonitorSmartphone', 'digital', ['web'], '/service-heroes/web-design-development.webp', {
    ...
    seoTitle: 'شركة تصميم وبرمجة مواقع في 6 أكتوبر', metaDescription: 'تصميم وبرمجة مواقع شركات ومتاجر سريعة ومتوافقة مع الموبايل ومحركات البحث من مدينة 6 أكتوبر، الجيزة.', keywords: ['تصميم مواقع شركات', 'برمجة مواقع', 'متجر إلكتروني', 'تصميم UI/UX'],
  }, {
    ...
    seoTitle: 'Web Design Agency in 6th of October', metaDescription: 'Responsive company website and e-commerce development from 6th of October, focused on speed, clarity and maintainability.', keywords: ['company website design', 'web development', 'ecommerce website', 'responsive UI UX'],
  }),
