export const REGISTRATION_TERMS_VERSION = '2026-09-22';
export const CLIENT_BOOKING_POLICY = Object.freeze({ opens: '12:00', closes: '22:00', closed_weekday: 5, cancellation_hours: 48 });
export const CLIENT_BOOKING_POLICY_LABEL = 'يوميًا من 12 ظهرًا إلى 10 مساءً، عدا الجمعة.';
export const CANCELLATION_TERMS = 'يجب طلب تأجيل الموعد أو إلغائه قبل موعد التصوير بـ 48 ساعة على الأقل. بخلاف ذلك يظل الموعد مؤكدًا وتُخصم مدته من الباقة.';
