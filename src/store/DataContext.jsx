...
const defaultData = {
  ...
  portfolio: [
    ...
    { id: 7, projectUrl: 'https://qpshoes.shop/', imageUrl: 'https://image.thum.io/get/width/800/crop/600/https://qpshoes.shop/', title: 'متجر QP Shoes', titleEn: 'QP Shoes Store', category: 'web' }
  ],
  contact: {
...
export const DataProvider = ({ children }) => {
  const [siteData, setSiteData] = useState(() => {
    const saved = localStorage.getItem('mt_agency_data_v3');
    if (saved) {
      try {
  ...
  useEffect(() => {
    localStorage.setItem('mt_agency_data_v3', JSON.stringify(siteData));
  }, [siteData]);
